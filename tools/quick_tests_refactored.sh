...
echo "WAC"
$T "$1" ${2:-"--quiet"} --results-dir "$RESULTS_DIR" best $TOOLS/test_files/win_at_chess_test.epd --depth 6
echo

echo "BKT"
$T "$1" ${2:-"--quiet"} --results-dir "$RESULTS_DIR" best $TOOLS/test_files/bratko_kopec_test.epd --depth 6
echo
